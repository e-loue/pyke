...
_lr_productions = [
  ("S'",1,None,None,None),
  ('file',2,'p_file','/home/bruce/python/workareas/sf.trunk/pyke/krb_compiler/kfbparser.py',36),
  ('facts',0,'p_file','/home/bruce/python/workareas/sf.trunk/pyke/krb_compiler/kfbparser.py',37),
  ('facts',2,'p_file','/home/bruce/python/workareas/sf.trunk/pyke/krb_compiler/kfbparser.py',38),
  ('fact',4,'p_fact0','/home/bruce/python/workareas/sf.trunk/pyke/krb_compiler/kfbparser.py',43),
  ('fact',5,'p_fact1','/home/bruce/python/workareas/sf.trunk/pyke/krb_compiler/kfbparser.py',47),
  ('data',1,'p_none','/home/bruce/python/workareas/sf.trunk/pyke/krb_compiler/kfbparser.py',51),
  ('comma_opt',0,'p_none','/home/bruce/python/workareas/sf.trunk/pyke/krb_compiler/kfbparser.py',52),
